...
|`SeRestore`| ***Admin*** | 3rd party tool | Critical OS file replacement. | To be investigated. Fully reproductible path needs to be tested, but I was able to gain admin rights with this privilege.|
